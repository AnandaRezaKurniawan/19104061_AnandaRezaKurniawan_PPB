package com.anandarezakurniawan_19104061.sharedpreferences
...
import com.anandarezakurniawan_19104061.sharedpreferences.databinding.ActivitySettingPreferenceBinding
...
class SettingPreferenceActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onClick(p0: View?) {
        if (p0?.id == R.id.btn_save) {
            ...
            setResult(RESULT_CODE, resultIntent) //return ke MainActivity
            finish()
        }
